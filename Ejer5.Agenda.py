...
class Directorio:
# iniciamos nuestra clase con el metodo constructor
	def __init__(self):
# crearemos un diccionario donde guardaremos los datos de nuestra agenda
		self.contactos=[]

# menu del programa
	def menu(self):
		menu=["Agenda Personal", "1. Añadir Contacto", "2. Lista de contactos", "3. Buscar contacto", "4. Editar contacto", "5. Cerrar agenda"]
		for x in range(5):
